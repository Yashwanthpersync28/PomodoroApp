  ...
  return (
    ...
    onBackdropPress={onClose}
      ...
      <TouchableOpacity onPress={onClose} style={[flex(1)]}>
        ...
        <View style={[flex(0.4), { width: widthValue(1) }, Darkmode?styles.bgtaskCardDblack:styles.bgWhite, radius(0, 20, 0, 0, 20), paddingPosition(0, 20, 0, 20)]}>
          {/* header */}
          <View style={[styles.allCenter, flex(0.4), borderColor(Darkmode?Colors.darkmodeBorderColor:'#e3e1e1'), borderWidth(0, 0, 0, 1)]}>
          ...
          <View style={[flex(0.8),padding(20),styles.allCenter,]}>
            <Text style={[styles.textCenter,Darkmode?styles.inputColor:styles.black,fontWeight('bold'),fontSize(18)]}>{`Are you sure you want to delete the "${Taskname}" ${name}?`}</Text>
          </View>
          {/* footer */}
          <View style={[flex(0.5), styles.row, styles.allCenter,borderColor(Darkmode?Colors.darkmodeBorderColor:'#e3e1e1'), borderWidth(0,1)]}>
            <View style={[styles.spaceBetweenVertical, styles.row, flex(1)]}>
              <CustomizedButtons name={'Cancel'} bgcolor={Darkmode?styles.bgDarkmodebutton:styles.bgsmokeOrange} color={Darkmode?styles.white:styles.Orange} style={[{ width: widthValue(2.5) }]} handlecontinue={()=>onClose()}/>
