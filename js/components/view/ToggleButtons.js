...
export const ToggleButtons = ({onPressProject,showProjects,onPressTags}) => {
  return (
   <View style={[styles.bgsmokeOrange,{height:heightValue(20)},marginPosition(10)]}>
    <View style={[styles.row,radius(10),flex(1),{backgroundColor:'#f5f5f5'}]}>
        ...
        <View style={[flex(1),styles.allCenter,radius(5),showProjects?styles.bgOrange:null]}>
            <Text style={[{fontWeight:'bold'},showProjects?styles.white:styles.black]}>Projects</Text>
        </View>
        </TouchableOpacity>
        ...
        <Text style={[{fontWeight:'bold'},showProjects?styles.black:styles.white]}>Tags</Text>
        </View>
        </TouchableOpacity>
    </View>
   </View>
