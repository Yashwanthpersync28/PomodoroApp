    ...
    <StatusBar backgroundColor = "white" barStyle = "dark-content"/>
      ...
      <ScrollView style={[flex(1),{zIndex: 0 },styles.bgWhite]} showsVerticalScrollIndicator={false}>
        ...
        <View style={[{height:heightValue(2.8)},styles.rowWrap,styles.spaceEvenly]}>
           ...
           <ManageButtons  color={'#fdaf63'} heading={'This Week'} IconFamily={Icons.Foundation} iconname={'calendar'} hours={'13h 20m (10s)'} showhours={true} handlebuttons={()=>navigation.navigate('tasklists',{name:'This Week',data:getTasksThisWeekdata,completedData:getCompletedtasksThisWeek})}/>
           <ManageButtons  color={'#af4fba'} heading={'Planned'} IconFamily={Icons.FontAwesome} iconname={'calendar-check-o'} hours={'13h 20m (10s)'} showhours={true} handlebuttons={()=>navigation.navigate('tasklists',{name:'Planned',data:getTasksThisMonthdata,completedData: getCompletedtasksthisMonth})}/>
...
//         {modalVisible ? count===7 ? <DueDateModal visible={modalVisible} onClose={onClose} OnpressDate={(val,color,IconName,IconFamily,day)=>setSelectedDate({DateSelected:val,Color:color,iconname:IconName,iconFamily:IconFamily,Day:day})} handletoAddtask={(val)=>setcount(val)}/>:null:null} */}
//        {modalVisible ? count===0 ? <PlusModal visible={modalVisible} onClose={onClose} handleCount={(val)=>setcount(val)}/> :null:null}
//        {modalVisible ? count===1 ? <AddTask visible={modalVisible} onClose={onClose}/> :null:null}
...
//            <ManageButtons  color={'#6fbe6d'} heading={'Today'} IconFamily={Icons.FontAwesome} iconname={'calendar-check-o'} hours={'13h 20m (10s)'} showhours={true} handlebuttons={()=>navigation.navigate('tasklists',{name:'Today',data:TodayTasks,completedData:CompletedTodayTasks})}/>
//            <ManageButtons color={'#3ca2f2'} heading={'Tomorrow'} IconFamily={Icons.FontAwesome} iconname={'calendar-check-o'} hours={'13h 20m (10s)'} showhours={true} handlebuttons={()=>navigation.navigate('tasklists',{name:'Tomorrow',data:TomorrowTasks,completedData:CompletedTasksTomorrow})}/>
//            <ManageButtons  color={'#fdaf63'} heading={'This Week'} IconFamily={Icons.Foundation} iconname={'calendar'} hours={'13h 20m (10s)'} showhours={true} handlebuttons={()=>navigation.navigate('tasklists',{name:'This Week',data:TomorrowTasks,completedData:CompletedTasksTomorrow})}/>
