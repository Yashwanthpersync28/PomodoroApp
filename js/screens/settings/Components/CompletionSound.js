...
import Icon,{ Icons } from '../../../components/Icons';
  ...
  export const CompletionSound = ({closeModal,currentModal,selectedTune,handleNoise,updateNoise,playSound,stopSound,CompletionSounds}) => {

     const renderTunes=({item})=>{
      const isSelected = selectedTune === item.MusicName
      return(
        <TouchableOpacity onPress={()=>{handleNoise(item),closeModal()}}>
...
<FlatList data={CompletionSounds} renderItem={renderTunes} keyExtractor={item=>item.id}/>
